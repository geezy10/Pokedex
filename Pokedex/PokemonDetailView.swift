                ...
                VStack {
                    ...
                    ZStack{
                        ...
                        VStack(alignment: .leading, spacing: 15) {
                            StatBarView(statName: "HP", value: pokemon.hp, barColor: .red)
                            StatBarView(statName: "Att.", value: pokemon.attack, barColor: .orange)
                            StatBarView(statName: "Def.", value: pokemon.defense, barColor: .yellow)
                            StatBarView(statName: "Sp. Att.", value: pokemon.specialAttack, barColor: .blue)
                            StatBarView(statName: "Sp. Def", value: pokemon.specialDefense, barColor: .green)
                            StatBarView(statName: "Speed", value: pokemon.speed, barColor: .pink)
                        }
                        .padding()
                    }//end of zstack stats
